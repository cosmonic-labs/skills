---
name: helm-charts
description: "Helm chart authoring conventions for values.yaml structure, Go template patterns, naming rules, templates/ directory layout, image configuration, and CRD handling. Use when creating new Helm charts, writing Chart.yaml and values.yaml, structuring templates/ directories, configuring RBAC and ServiceAccount resources, or setting up chart dependencies."
license: Apache-2.0
metadata:
  tags:
    - helm
